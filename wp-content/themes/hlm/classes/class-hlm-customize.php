		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'hlm' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'hlm' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'hlm' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'hlm' ),
						'full'    => esc_html__( 'Full text', 'hlm' ),
					),
				)
			);
			...
			require_once get_theme_file_path( 'classes/class-hlm-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'hlm_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new hlm_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'hlm' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
