	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="entry-content">
			<figure class="wp-block-image">
				 ...
				 */
				$image_size = apply_filters( 'hlm_attachment_size', 'full' );
		...
		<footer class="entry-footer default-max-width">
			...
			if ( $metadata ) {
				printf(
					...
					esc_html_x( 'Full size', 'Used before full size attachment link.', 'hlm' ), // phpcs:ignore WordPress.Security.EscapeOutput
